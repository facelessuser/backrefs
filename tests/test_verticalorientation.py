...
from backrefs.uniprops.unidata import verticalorientation
...
class TestVerticalOrientation(unittest.TestCase):
    ...
    def test_table_integrity(self):
        ...
        keys1 = set(verticalorientation.unicode_vertical_orientation.keys())
        keys2 = set(verticalorientation.ascii_vertical_orientation.keys())
    ...
    def test_verticalorientation(self):
        ...
        for k, v in verticalorientation.unicode_vertical_orientation.items():
    ...
    def test_verticalorientation_ascii(self):
        ...
        for k, v in verticalorientation.ascii_vertical_orientation.items():
    ...
    def test_alias(self):
        ...
        for k, v in alias.unicode_alias['verticalorientation'].items():
