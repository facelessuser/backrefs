...
from backrefs.uniprops.unidata import joiningtype
...
class TestJoiningType(unittest.TestCase):
    ...
    def test_table_integrity(self):
        ...
        keys1 = set(joiningtype.unicode_joining_type.keys())
        keys2 = set(joiningtype.ascii_joining_type.keys())
    ...
    def test_joiningtype(self):
        ...
        for k, v in joiningtype.unicode_joining_type.items():
    ...
    def test_joiningtype_ascii(self):
        ...
        for k, v in joiningtype.ascii_joining_type.items():
    ...
    def test_alias(self):
        ...
        for k, v in alias.unicode_alias['joiningtype'].items():
