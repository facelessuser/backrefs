...
from backrefs.uniprops.unidata import numerictype
...
class TestNumericType(unittest.TestCase):
    ...
    def test_table_integrity(self):
        ...
        keys1 = set(numerictype.unicode_numeric_type.keys())
        keys2 = set(numerictype.ascii_numeric_type.keys())
    ...
    def test_numerictype(self):
        ...
        for k, v in numerictype.unicode_numeric_type.items():
    ...
    def test_numerictype_ascii(self):
        ...
        for k, v in numerictype.ascii_numeric_type.items():
    ...
    def test_alias(self):
        ...
        for k, v in alias.unicode_alias['numerictype'].items():
