...
from backrefs.uniprops.unidata import decompositiontype
...
class TestDecompositionType(unittest.TestCase):
    ...
    def test_table_integrity(self):
        ...
        keys1 = set(decompositiontype.unicode_decomposition_type.keys())
        keys2 = set(decompositiontype.ascii_decomposition_type.keys())
    ...
    def test_decompositiontype(self):
        ...
        for k, v in decompositiontype.unicode_decomposition_type.items():
    ...
    def test_decompositiontype_ascii(self):
        ...
        for k, v in decompositiontype.ascii_decomposition_type.items():
    ...
    def test_alias(self):
        ...
        for k, v in alias.unicode_alias['decompositiontype'].items():
